  ...
  class RegistrationsController < DeviseTokenAuth::ApplicationController
    ...
    def create
      ...
      begin
        ...
        resource_klass.set_callback('create', :after, :send_on_create_confirmation_instructions)
        resource_klass.skip_callback('create', :after, :send_on_create_confirmation_instructions)
    ...
    def build_resource
      @resource            = resource_klass.new(sign_up_params)
      @resource.provider   = provider

      # honor devise configuration for case_insensitive_keys
      if resource_klass.case_insensitive_keys.include?(:email)
